              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <Input type="number" value={editingExpense.amount || ""} onChange={e => setEditingExpense(p => ({ ...p!, amount: e.target.value === "" ? 0 : Number(e.target.value) }))} className="rounded-xl h-10" />
                  </div>
                  <div>
            ...
            <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }} transition={{ type: "spring", damping: 25 }}
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <Input type="number" value={editingBudget.allocated || ""} onChange={e => setEditingBudget(p => ({ ...p!, allocated: e.target.value === "" ? 0 : Number(e.target.value) }))} className="rounded-xl h-10" placeholder="50000" />
                </div>
                <div>
                  <label className="text-[11px] font-medium text-muted-foreground mb-1 block">Notes</label>
