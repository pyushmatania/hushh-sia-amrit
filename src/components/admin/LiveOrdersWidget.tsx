    ...
    >
      ...
      <div className="relative flex items-center justify-between mb-5">
        <h3 className="text-[13px] font-bold text-foreground flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center shadow-lg shadow-orange-500/10">
            <ShoppingCart size={15} className="text-white" />
          </div>
          Live Kitchen
          {orders.length > 0 && (
            <span className="px-2 py-0.5 rounded-full bg-orange-500/10 text-orange-500 text-[10px] font-bold animate-pulse">
              {orders.length}
            </span>
          )}
        </h3>
        <button onClick={onViewAll} className="text-[11px] text-primary font-medium flex items-center gap-0.5 hover:underline">
