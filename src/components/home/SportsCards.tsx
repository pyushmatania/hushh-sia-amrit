...
export default function SportsCards({ properties, onPropertyTap }: SportsCardsProps) {
  const sportsData: SportActivity[] = [
    {
      name: "Pickleball",
      icon: icon3dPickleball,
      venues: [
        {
          name: "Hushh Farmhouse | Court 1",
        ...
        {
          name: "Sports Arena Jeypore",
          image: properties[5]?.images[0] || "",
          distance: "1.2 km",
          area: "Station Rd",
          slots: ["8 PM", "9 PM", "10 PM"],
        },
      ],
    },
    {
      name: "Badminton",
      icon: icon3dBadminton,
      venues: [
        {
    ...
    },
    {
      ...
      venues: [
        {
          name: "Adventure Zone",
          image: properties[2]?.images[0] || "",
          distance: "2 km",
          area: "Outskirts",
          slots: ["5 PM", "6 PM", "7 PM"],
        },
      ],
    },
    {
      ...
      venues: [
        {
          name: "Firefly Villa Pool",
          image: properties[0]?.images[0] || "",
          distance: "0.5 km",
          area: "Jeypore",
          slots: ["10 AM", "2 PM", "5 PM"],
        },
      ],
    },
  ];
      ...
      {sportsData.map((sport) => (
        ...
        >
                ...
                <div className="flex gap-2 flex-wrap">
                  {venue.slots.map((slot) => (
                    <motion.button
                      key={slot}
                      whileTap={{ scale: 0.95 }}
                      className="rounded-full px-4 py-2 text-sm text-foreground font-medium transition-colors"
                      style={{
          ...
          <div className="mt-5 flex justify-center">
            <button
              className="flex items-center gap-1.5 rounded-full px-6 py-2.5 text-sm text-foreground/50 font-medium"
