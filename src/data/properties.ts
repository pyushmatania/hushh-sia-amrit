...
export const properties: Property[] = [
  ...
  },
  {
    ...
    slots: [
      { id: "s1", label: "Morning", time: "8 AM - 12 PM", price: 1299, available: true },
  ...
  },
  {
    ...
    slots: [
      { id: "s1", label: "Morning", time: "8 AM - 12 PM", price: 1499, available: true },
      { id: "s2", label: "Afternoon", time: "12 PM - 4 PM", price: 1799, available: true },
      { id: "s3", label: "Evening", time: "4 PM - 8 PM", price: 2299, available: true, popular: true },
      { id: "s4", label: "Night", time: "8 PM - 12 AM", price: 2799, available: true },
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "s5", label: "Full Day", time: "6 AM - 10 PM", price: 2499, available: true },
    ],
  ...
  },
  {
    ...
    slots: [
      { id: "s1", label: "Morning", time: "8 AM - 12 PM", price: 2499, available: true },
      ...
      { id: "s4", label: "Night", time: "8 PM - 12 AM", price: 3499, available: true },
      { id: "s5", label: "Full Day", time: "8 AM - 12 AM", price: 7999, available: true },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "s5", label: "Full Day", time: "9 AM - 11 PM", price: 9999, available: true },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "s3", label: "Night", time: "8 PM - 12 AM", price: 4499, available: true },
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "s4", label: "Full Day", time: "8 AM - 10 PM", price: 11999, available: true },
    ],
...
export const addons: Record<string, Addon[]> = {
  "Food & Drinks": [
    { id: "f1", category: "Food & Drinks", categoryEmoji: "🍽️", emoji: "🍛", name: "Tribal Thali", description: "Authentic Koraput cuisine", price: 349, perPerson: true },
    { id: "f2", category: "Food & Drinks", categoryEmoji: "🍽️", emoji: "🥩", name: "BBQ Platter", description: "Chicken + Paneer + Corn", price: 499, perPerson: true },
    { id: "f3", category: "Food & Drinks", categoryEmoji: "🍽️", emoji: "☕", name: "Chai & Maggi Station", description: "Unlimited refills", price: 99, perPerson: true },
    { id: "f4", category: "Food & Drinks", categoryEmoji: "🍽️", emoji: "🍕", name: "Pizza Station", description: "Freshly baked wood-fire", price: 399, perPerson: true },
    { id: "f5", category: "Food & Drinks", categoryEmoji: "🍽️", emoji: "🍰", name: "Dessert Bar", description: "Gulab jamun, ice cream & more", price: 249, perPerson: true },
    { id: "f6", category: "Food & Drinks", categoryEmoji: "🍺", emoji: "🍺", name: "Beer Bucket (6)", description: "Assorted beer selection", price: 699 },
    { id: "f7", category: "Food & Drinks", categoryEmoji: "🥤", emoji: "🥤", name: "Soft Drinks + Ice", description: "Coke, Sprite, mixers + ice", price: 199 },
    { id: "f8", category: "Food & Drinks", categoryEmoji: "🎂", emoji: "🎂", name: "Custom Cake", description: "1 kg themed cake", price: 799 },
  ],
  "Decoration": [
    { id: "d1", category: "Decoration", categoryEmoji: "🎨", emoji: "🕯️", name: "Romantic Setup", description: "Candles, petals, fairy lights", price: 999 },
    { id: "d2", category: "Decoration", categoryEmoji: "🎨", emoji: "🎈", name: "Birthday Setup", description: "Balloons, banner, cake table", price: 1499 },
    { id: "d3", category: "Decoration", categoryEmoji: "🎨", emoji: "💡", name: "Neon Sign", description: "Customizable message", price: 499 },
    { id: "d4", category: "Decoration", categoryEmoji: "🎨", emoji: "🌫️", name: "Fog Machine", description: "Dramatic entrance effect", price: 699 },
    { id: "d5", category: "Decoration", categoryEmoji: "🌸", emoji: "🌸", name: "Flower Wall", description: "Instagram-worthy backdrop", price: 1999 },
  ],
  "Music & Entertainment": [
    { id: "m1", category: "Music & Entertainment", categoryEmoji: "🎵", emoji: "🔊", name: "Bluetooth Speaker", description: "Included with booking", price: 0 },
    { id: "m2", category: "Music & Entertainment", categoryEmoji: "🎵", emoji: "🎧", name: "DJ (2 hours)", description: "Professional DJ setup", price: 2999 },
    { id: "m3", category: "Music & Entertainment", categoryEmoji: "🎵", emoji: "🎤", name: "Karaoke Setup", description: "Mic + screen + 500 songs", price: 799 },
    { id: "m4", category: "Music & Entertainment", categoryEmoji: "🎵", emoji: "🎸", name: "Live Acoustic", description: "Guitar + vocalist 1 hour", price: 1999 },
    { id: "m5", category: "Music & Entertainment", categoryEmoji: "🎮", emoji: "🎮", name: "PS5 Console", description: "2 controllers + 10 games", price: 499 },
    { id: "m6", category: "Music & Entertainment", categoryEmoji: "🎬", emoji: "📽️", name: "Projector + Screen", description: "25ft outdoor cinema", price: 599 },
  ],
  "Activities": [
    { id: "a1", category: "Activities", categoryEmoji: "🏊", emoji: "🏊", name: "Pool Access", description: "Heated private pool", price: 299, perPerson: true },
    { id: "a2", category: "Activities", categoryEmoji: "🏊", emoji: "🏓", name: "Pickleball Court", description: "1 hour session", price: 399 },
    { id: "a3", category: "Activities", categoryEmoji: "🏊", emoji: "🔭", name: "Telescope Session", description: "Guided stargazing 1 hour", price: 499 },
    { id: "a4", category: "Activities", categoryEmoji: "🏊", emoji: "💃", name: "Tribal Dance Class", description: "30 min with local artists", price: 799 },
    { id: "a5", category: "Activities", categoryEmoji: "🔥", emoji: "🔥", name: "Bonfire Setup", description: "Firewood + marshmallows", price: 499 },
  ],
  "Work Add-ons": [
    { id: "w1", category: "Work Add-ons", categoryEmoji: "💻", emoji: "📶", name: "WiFi Boost", description: "Dedicated 100 Mbps line", price: 199 },
    { id: "w2", category: "Work Add-ons", categoryEmoji: "💻", emoji: "🖥️", name: "Work Desk Setup", description: "Monitor + keyboard + mouse", price: 299 },
    { id: "w3", category: "Work Add-ons", categoryEmoji: "☕", emoji: "☕", name: "Unlimited Coffee", description: "Filter + espresso all day", price: 149 },
    { id: "w4", category: "Work Add-ons", categoryEmoji: "🔇", emoji: "🔇", name: "Quiet Room Access", description: "Soundproofed private room", price: 399 },
  ],
  "Comfort Add-ons": [
    { id: "co1", category: "Comfort Add-ons", categoryEmoji: "🛏️", emoji: "🛏️", name: "Extra Mattress", description: "Premium foam mattress", price: 299 },
    { id: "co2", category: "Comfort Add-ons", categoryEmoji: "❄️", emoji: "❄️", name: "AC Upgrade", description: "Premium split AC", price: 399 },
    { id: "co3", category: "Comfort Add-ons", categoryEmoji: "🪑", emoji: "🪑", name: "Premium Seating", description: "Bean bags + lounge chairs", price: 499 },
    { id: "co4", category: "Comfort Add-ons", categoryEmoji: "⏰", emoji: "⏰", name: "Extra Hour", description: "Extend your slot by 1 hour", price: 399 },
    { id: "co5", category: "Comfort Add-ons", categoryEmoji: "🌅", emoji: "🌅", name: "Early Check-in", description: "Start 1 hour early", price: 299 },
    { id: "co6", category: "Comfort Add-ons", categoryEmoji: "🌙", emoji: "🌙", name: "Late Checkout", description: "Stay 1 hour extra", price: 299 },
  ],
  "Staff & Extras": [
    { id: "e1", category: "Staff & Extras", categoryEmoji: "📸", emoji: "📸", name: "Photographer", description: "30 min shoot", price: 1499 },
    { id: "e2", category: "Staff & Extras", categoryEmoji: "🎁", emoji: "🎁", name: "Surprise Reveal", description: "Custom setup", price: 799 },
    { id: "e3", category: "Staff & Extras", categoryEmoji: "🕯️", emoji: "🕯️", name: "Candlelight Dinner", description: "Private table setup", price: 1999 },
    { id: "e4", category: "Staff & Extras", categoryEmoji: "✨", emoji: "✨", name: "Fireworks Mini", description: "5 min sparkler show", price: 999 },
    { id: "e5", category: "Staff & Extras", categoryEmoji: "📹", emoji: "📹", name: "Video Reel", description: "60-sec edited reel", price: 1999 },
    { id: "e6", category: "Staff & Extras", categoryEmoji: "👨‍🍳", emoji: "👨‍🍳", name: "Private Chef", description: "3-course meal + service", price: 2999 },
    { id: "e7", category: "Staff & Extras", categoryEmoji: "🧹", emoji: "🧹", name: "Cleanup Crew", description: "Post-event deep clean", price: 499 },
    { id: "e8", category: "Staff & Extras", categoryEmoji: "🚗", emoji: "🚗", name: "Pickup & Drop", description: "AC car from station/airport", price: 499 },
  ],
};
